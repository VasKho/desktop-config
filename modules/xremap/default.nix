  ...
  services.xremap = {
    ...
    config = {
      ...
      keymap = [
        {
          name = "Navigation";
          application.not = ["dev.zed.Zed" "com.mitchellh.ghostty"];
          exact_match = true;
          remap = {
            C-b = { with_mark = "left"; };
            C-f = { with_mark = "right"; };
            C-n = { with_mark = "down"; };
            C-p = { with_mark = "up"; };
            C-M-b = { with_mark = "C-left"; };
            C-M-f = { with_mark = "C-right"; };
            C-M-n = { with_mark = "C-down"; };
            C-M-p = { with_mark = "C-up"; };
            C-a = { with_mark = "home"; };
            C-e = { with_mark = "end"; };
            C-d = [ "delete" { set_mark = false; } ];
            C-M-d = [ "C-delete" { set_mark = false; } ];
            C-k = [ "Shift-end" "backspace" { set_mark = false; } ];
